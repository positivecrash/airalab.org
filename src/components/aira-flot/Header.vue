...
@media screen and (max-width: 972px) {
  ...
  .aira-flot-nav::after {
    ...
    clip-path: polygon(0% 0%, 55% 0, 100% 49%, 59% 100%, 0% 100%);
  }

  .aira-flot-nav--active {
...
@media screen and (max-width: 520px) {
  ...
  .aira-flot-header__container img {
    width: 80%;
  }
}
